  ...
  const outlineItems = [
    {
      ...
      href: '/user/outline-lsp/visi-misi'
    },
    {
      ...
      href: '/user/outline-lsp/struktur-organisasi'
    },
    {
      id: 'daftar-mitra',
      icon: '🤝',
      ...
      href: '/user/outline-lsp/daftar-mitra'
    },
    {
      ...
      href: '/user/outline-lsp/skema-sertifikasi'
    },
    {
    ...
    },
    {
      ...
      href: '/user/outline-lsp/tempat-uji-kompetensi'
    }
  ];
